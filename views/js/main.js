...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImage.src = "images/pizza.png";    // image size optimized
...
function updatePositions() {
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    items[i].style.transform = 'translate3d(' + ((i % 7) * 256 + 100 * phase) + 'px, 0px, 0px)';
  }
...
// optimized scroll and rAF for pizza sliders
